...
export const Landing = () => {
    ...
    return <main className="flex flex-col">
        <header className="fixed w-full p-4 bg-white shadow-xs">
        ...
        <section className="flex items-center justify-center min-h-svh px-4 bg-blue-50">
            <div className="flex flex-col items-center gap-10 max-w-7xl mx-auto">
                ...
                <h1 className="text-center font-bold text-4xl sm:text-5xl md:text-7xl">Aprende nuevas habilidades en <span className="text-blue-600">Eido Academy</span></h1>
                ...
                <button className="flex items-center font-semibold gap-2 px-4 py-2 rounded-lg bg-blue-600 text-white cursor-pointer active:scale-95 hover:bg-blue-800 transition-all">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                    {
                        characteristics.map((characteristic, index) => (
                            <div key={index} className="flex flex-col items-center gap-2 px-8 py-12 rounded-lg bg-white border-1 border-gray-200 transition-all hover:shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {
                        reviews.map((review, index) => (
                            <div key={index} className="flex flex-col gap-2 px-8 py-12 rounded-lg bg-white border-1 border-gray-200 transition-all hover:shadow-sm">
                                <p>⭐⭐⭐⭐⭐</p>
        ...
        <section className="flex flex-col gap-8 items-center justify-center py-24 px-4 bg-blue-600 text-white">
            ...
            <button className="flex items-center font-semibold gap-2 px-4 py-2 rounded-lg bg-white text-blue-600 cursor-pointer active:scale-95 hover:bg-gray-100 transition-all">
                Comenzar ya <ArrowRight />
            </button>
        </section>
        <footer className="flex flex-col py-8 px-4 gap-6 bg-blue-950 text-white">
            ...
            <div className="w-full max-w-7xl mx-auto border-b-1 pb-1 border-b-gray-400" />
